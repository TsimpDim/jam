...
from .models import Group, JobApplication, JobAppFile, JobAdSnapshot, LeadSnapshot, Step, Timeline, Lead, CV, Notification, NotificationType
...
class JobAppFileSerializer(serializers.ModelSerializer):
    class Meta:
        model = JobAppFile
