...
describe('NotificationService', () => {
  ...
  describe('initial state', () => {
    ...
    it('should start with unreadOnly false', () => {
      expect(service.unreadOnly()).toBeFalse();
    });
  ...
  describe('markAsRead', () => {
    it('should optimistically update notification', async () => {
      ...
      const req = httpMock.expectOne(
        `${environment.apiUrl}/jam/notifications/1/mark-read/`,
      );
      req.flush({ status: 'ok' });
      await promise;
      expect(service.notifications()[0].is_read).toBeTrue();
  ...
  describe('filteredNotifications', () => {
    it('should return all when unreadOnly is false', () => {
      service.notifications.set([
        {
          id: 1,
          text: 'A',
    ...
    it('should return only unread when unreadOnly is true', () => {
  ...
  describe('toggleUnreadOnly', () => {
    it('should toggle unreadOnly', () => {
      expect(service.unreadOnly()).toBeFalse();
      service.toggleUnreadOnly();
      expect(service.unreadOnly()).toBeTrue();
      service.toggleUnreadOnly();
      expect(service.unreadOnly()).toBeFalse();
    });
  });
